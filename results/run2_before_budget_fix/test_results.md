...
Run: 2026-09-17 11:17  |  Model: `gemini-3.5-flash` (fallback `gemini-3.5-flash-lite`)  |  langchain 1.4.1, langgraph 1.2.11
...
**Scenarios passed: 8/10**  |  checks passed: 38/40

| ID | Scenario | Category | Result | Tool calls (failed) | Model calls (failed) | Tokens | Time (s) | Numeric grounding |
|---|---|---|---|---|---|---|---|---|
| S1 | Full trip plan (Jaipur) | core | FAIL | 7 (1) | 3 (1) | 15,345 | 65.6 | 13/13 |
| S2 | Quick weather question (Tokyo weekend) | core | PASS | 2 (0) | 3 (1) | 5,737 | 43.9 | 8/8 |
| S3 | Currency conversion (USD to EUR and INR) | core | PASS | 2 (0) | 2 (1) | 3,650 | 28.8 | 5/5 |
| S4 | Multi-turn memory (Udaipur) | memory | PASS | 4 (0) | 5 (1) | 14,405 | 77.3 | 17/18 |
| S5 | Unknown destination (tool returns place_not_found) | failure | PASS | 1 (1) | 2 (1) | 3,414 | 29.0 | n/a |
| S6 | Dates beyond the forecast horizon (Manali in two months) | failure | FAIL | 8 (1) | 4 (1) | 19,566 | 61.5 | 14/14 |
| S7 | Unsupported currency, fallback provider (AED to INR) | failure | PASS | 1 (0) | 2 (1) | 3,492 | 27.9 | 3/3 |
| S8 | Empty API response (India public holidays) | failure | PASS | 2 (1) | 2 (1) | 3,983 | 30.9 | n/a |
| S9 | Weather service outage (simulated) | failure | PASS | 6 (4) | 7 (1) | 15,216 | 104.7 | n/a |
| S10 | Off-topic request / prompt injection | guardrail | PASS | 0 (0) | 1 (1) | 1,652 | 16.1 | n/a |
...
Tools used: geocode_place, get_weather, get_public_holidays (failed: no_data), get_destination_guide, get_destination_guide, get_destination_guide, estimate_trip_budget
...
Tools used: geocode_place, get_destination_guide, get_destination_guide, get_destination_guide, get_weather, get_public_holidays (failed: no_data), get_weather, estimate_trip_budget
...
Tools used: geocode_place, geocode_place (failed: place_not_found), get_weather (failed: place_not_found), geocode_place (failed: place_not_found), geocode_place, get_weather (failed: weather_unavailable)
